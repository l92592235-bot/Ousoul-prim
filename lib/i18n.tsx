...
const AR: Dict = {
  ...
  'contract.list.startLabel': 'يبدأ',
  'contract.list.endLabel': 'ينتهي',
  'contract.field.startDate': 'تاريخ بداية العقد (اختياري)',
  'contract.field.deadline': 'تاريخ انتهاء العقد *',
  ...
  'contract.documents.title': 'مستندات العقد',
  'contract.documents.upload': 'رفع ملف',
  'contract.documents.uploading': 'جارٍ الرفع...',
  'contract.documents.saveFirst': 'اضغط "حفظ ومتابعة لإرفاق المستندات" أدناه أولًا، ثم سيظهر زر رفع الملفات هنا مباشرة.',
  'contract.action.saveAndAttach': 'حفظ ومتابعة لإرفاق المستندات',
  'contract.documents.empty': 'لا توجد مستندات مرفقة بعد.',
  'contract.document.tooLarge': 'حجم الملف يتجاوز الحد المسموح (15 ميجابايت).',
  'lang.toggle': 'English',
};
...
const EN: Dict = {
  ...
  'contract.list.startLabel': 'starts',
  'contract.list.endLabel': 'ends',
  'contract.field.startDate': 'Contract start date (optional)',
  'contract.field.deadline': 'Contract end / due date *',
  'contract.field.deadline.hint': 'This is when the contract ends or is due (not the start date).',
  'contract.field.status': 'Contract status',
  'contract.field.alertDays': 'Alert before deadline (days)',
  'contract.field.alertDays.hint': 'Example: entering 30 sends you an alert 30 days before the end date above. This is not the contract duration.',
  ...
  'action.save': 'Save',
  'action.done': 'Done',
  'contract.documents.title': 'Contract Documents',
  'contract.documents.upload': 'Upload File',
  'contract.documents.uploading': 'Uploading...',
  'contract.documents.saveFirst': 'Click "Save & Continue to Attach Documents" below first, then the upload button will appear here.',
  'contract.action.saveAndAttach': 'Save & Continue to Attach Documents',
  'contract.documents.empty': 'No documents attached yet.',
  'contract.document.tooLarge': 'File size exceeds the allowed limit (15MB).',
  'action.close': 'Close',
  'action.edit': 'Edit',
